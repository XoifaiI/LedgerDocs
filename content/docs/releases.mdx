...
+ What Peek with a MaxAge and Follow hand you is frozen, like every other read
...
! What Peek with a MaxAge and Follow hand you is frozen. Clone it before you change it
```
