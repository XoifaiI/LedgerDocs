...
A key many players write to fills at the rate all of them write to it. Every `Tx` leg, `Transfer`
and `Grant` adds one name. One name is about 40 bytes and lasts 30 days. That is about 1,700 of
