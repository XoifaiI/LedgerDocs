...
That's what makes a retry safe. Running the same id again doesn't do it twice. It finds every leg
...
[Limits](/docs/limits#transactions) says where those two numbers come from, and it is worth knowing
before you reach for a fourth leg.
